...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		<h1 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'wolf' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
	...
	<div class="entry-content">
		...
		<?php 
			the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'wolf' ) ); 
	...
	<footer class="entry-meta">
		...
		<?php edit_post_link( __( 'Edit', '_wolf' ), '<span class="sep"> | </span><span class="edit-link">', '</span>' ); ?>
	</footer><!-- .entry-meta -->
